<template>
  <el-dialog v-model="dialogVisible" :title="null" :width="width" :modal="true" :close-on-click-modal="false"
    :append-to-body="false" :modal-append-to-body="false" @close="handleClose">
